package com.yinkun.workgo.test.kit;
...
public class HttpUtils {
    ...
    public static String encryptMd5(Map<String, Object> map) {
    	String md5 = "";
    	try {
    		if (map != null) {
    			...
    			for (String string : list) {
    				...
    				if (v == null) {
    					...
    					md5_ += String.valueOf(v);
    				}
    			}
    			//确定计算方法
    	        MessageDigest md5Container = MessageDigest.getInstance("MD5");
    	        //加密后的字符串
    	        md5= Base64Encoder.encode(md5Container.digest(md5_.getBytes("utf-8")));
    		} else {
    			md5 = "";
    		}
    	} catch (Exception e) {
