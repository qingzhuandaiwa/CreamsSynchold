...
public class TenantModel {
	...
	private String hasCurrentContract;
	...
	public String getHasCurrentContract() {
		return hasCurrentContract;
	}

	public void setHasCurrentContract(String hasCurrentContract) {
		this.hasCurrentContract = hasCurrentContract;
	}
